# -*- coding: utf-8 -*-
"""
Time:     2021/7/25 18:10
Author:   panyuangao@foxmail.com
File:     html_report.py
Describe: 测试报告模板
"""
from Config.ProjConfigVar import report_path
...
if __name__ == '__main__':
    data = [('http://39.106.41.11:8080/register/',
             '{"username": "tiansl2831", "password": "wulaoshi123451", "email": "wulaoshi@qq.com"}',
             '{"username": "tiansl2831", "code": "01"}', "5ms", "00", '成功')]
    html_name = '接口测试报告'
