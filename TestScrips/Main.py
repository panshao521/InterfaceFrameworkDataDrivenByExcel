...
for test_sheet_name in get_test_case_sheet_names(test_data_excel_path):
    ...
    for test_case in test_cases:
        ...
        test_cases_wb.write_date_in_cell(int(test_case[0]+1),test_data_executed_time_col_no+1)
        try:
    ...
    test_cases_wb.write_date_in_cell(int(test_sheet_name[0]) + 1, test_case_executed_time_col_no)
