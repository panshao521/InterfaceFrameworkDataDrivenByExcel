# -*- coding: utf-8 -*-
"""
Time:     2021/7/25 16:48
Author:   panyuangao@foxmail.com
File:     interface.py
Describe: 配置接口信息
"""
from Util.GetConfig import *
from Util.api_request import *
from Config.ProjConfigVar import server_address_conf_path
import os.path

#读取工程的配置文件
config_file_path = os.path.join(server_address_conf_path)
